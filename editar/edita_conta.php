...
<?php
	...
	if ($result = $mysqli->query($query)) {
		...
		echo '<div class="meio">';
		echo '<h3> Movimentação de conta '.$row['conta'].' </h3>';
		...
		echo '<b>Nome: </b> <input type="text" name="Nome" value = "'.$row['rg'].'" placeholder="Nome do cliente" maxlength="60" size =40 required readonly="true" ><br>';
		...
		$Dts=date("d/m/Y");
		echo '<b>Data: </b> <input type="text" name="Data" placeholder="Data" value = "'.$Dts.'" maxlength="10" required size =10 readonly="true">';
		$Dts=date("H:i:s");
